         ...
         if rst = '1' then
            ...
            if cState = stWaitCen then
               if ram_wen_int = '0' then
                  -- For writes, ready as soon as we enter stWaitCen
                  ram_ready_o <= '1';
               elsif ram_oen_int = '0' and read_done = '1' then
                  -- For reads, ready when data is valid
                  ram_ready_o <= '1';
               else
                  ram_ready_o <= '0';
               end if;
