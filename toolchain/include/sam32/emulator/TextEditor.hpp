...
// NOTE: STOLEN FROM https://github.com/BalazsJako/ImGuiColorTextEdit
...
class TextEditor {
 ...
 private:
  ...
  float
      mTextStart;  // position (in pixels) where a code line starts relative to the left of the TextEditor.
  int mLeftMargin;
